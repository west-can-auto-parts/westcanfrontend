                    ...
                    <div className="w-full md:w-1/2">
                        ...
                        <div className="flex flex-wrap md:flex-nowrap gap-4 h-full items-stretch">
                            <div className="w-full md:w-1/2 col-md-12 mb-4 mb-lg-0">
                                <img src="https://res.cloudinary.com/dpeocx0yy/image/upload/v1726809389/pikaso_texttoimage_auto-parts-in-red-black-and-white-theme-_3_coqegs.jpg" className="w-100 shadow-1-strong rounded mb-4" alt="Boat on Calm Water" />
                                <img src="https://res.cloudinary.com/dpeocx0yy/image/upload/v1726809389/pikaso_texttoimage_auto-parts-for-cars-in-red-black-and-white-theme-_gkgbgs.jpg" className="w-100 shadow-1-strong rounded mb-4" alt="Wintry Mountain Landscape" />
                            </div>
                            <div className="w-full md:w-1/2 mb-4 mb-lg-0">
                                <img src="https://res.cloudinary.com/dpeocx0yy/image/upload/v1726728770/pikaso_texttoimage_images-of-an-auto-parts-store-with-red-white-black_1_glnff3.jpg" className="w-100 shadow-1-strong rounded mb-4" alt="Mountains in the Clouds" />
                                <img src="https://res.cloudinary.com/dpeocx0yy/image/upload/v1726809543/pikaso_texttoimage_auto-parts-store-receoption-desk-in-red-black-and-_gjftzj.jpg" className="w-100 shadow-1-strong rounded mb-4 object-cover h-fit" alt="Boat on Calm Water" />
                            </div>
                        </div>
                        {/* Gallery */}
                    </div>
