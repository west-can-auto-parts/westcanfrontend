        ...
        <div className="w-full lg:w-1/2 bg-white shadow-md rounded-lg">
                ...
                <div>
                    ...
                    <div className="p-8">
                        ...
                        {/* <p className="mt-4 text-sm">{locations[0].description}</p> */}
                        <button className='bg-[#b12b29] text-white px-6 py-2 font-bold mt-6 '>Know More</button>
                    </div>
                </div>
            ...
            (
                <div>
                    ...
                    <div className="p-8">
                        ...
                        {selectedStore.phone && <p>Phone: {selectedStore.phone}</p>}
                        {/* <p className="mt-4 text-sm">{selectedStore.description}</p> 
                        <button className='bg-[#b12b29] text-white px-6 py-2 font-bold mt-6 '>Know More</button>
                    </div>
                </div>
            )
